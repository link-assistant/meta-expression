...
| ID  | Surface                                                                                                                 | Where                            |
| --- | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| F1  | Reusable JS library (`analyzeStatement`, `formalizeTextWith`, `translateTextWith`, `checkText`, `searchTextUniqueness`) | `src/index.js`, `src/index.d.ts` |
| F2  | CLI                                                                                                                     | `src/cli.js`                     |
| F3  | Microservice (`GET /health`, `/analyze`, `/formalize`, `/translate`, `/check`, `/fact-check`, `/uniqueness`)            | `src/server.js`                  |
| F4  | Static web prototype (Analyse / Compare / Check / Uniqueness / Formalize / Translate / Preferences)                     | `web/index.html`, `web/app.js`   |
| F5  | Statement interpretation pipeline (top-3 paraphrases, selection link)                                                   | `src/index.js`                   |
| F6  | Formal levels (`describeFormalizationLevel`) with executable flag                                                       | `src/index.js`                   |
| F7  | Exact arithmetic evaluation (equality + question shape)                                                                 | `src/index.js`                   |
| F8  | Real-world evidence with bounded confidence (Wikidata P36/P397/P398/P570 templates)                                     | `src/wikimedia-evidence.js`      |
| F9  | `correctness` (0..1) and `signedConfidence` (-1..+1) result metrics                                                     | `src/index.js`, issue #13 tests  |
| F10 | `/formalize` returning Markdown / Links Notation / HTML / CST                                                           | `src/formalize.js`               |
| F11 | `/translate` via formalized Wikidata Q/P + sentence rules                                                               | `src/translate.js`               |
| F12 | `/check` (`/fact-check`) with red-to-green coloring                                                                     | `src/check.js`                   |
| F13 | `/uniqueness` over public web + scholarly APIs                                                                          | `src/uniqueness.js`              |
| F14 | Preference profiles (worldview / context / God-slider)                                                                  | `src/preferences.js`             |
| F15 | Links Notation export everywhere                                                                                        | `src/lino.js`                    |
| F16 | Issue-report URL prefilled with the analysis state                                                                      | `src/index.js`                   |
