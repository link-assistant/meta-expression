...
| R44 | Translate through formalized Wikidata entities.               | MVP   | Translation first runs `/formalize`, then swaps resolved Q/P phrases for target-language Wikidata labels and sitelinks.      | Add broader predicate/fact translation rules.                                                                   |
