...
| R20 | Use Wikipedia/Wikidata for public knowledge.                 | MVP   | Fixture evidence exists; live Wikimedia resolver now supports liveness, capital, and orbit templates. | Harden live retrieval, add scoped WDQS, and later extract validated Wikipedia text claims.                      |
...
| R23 | Represent implied statements and dependencies.               | MVP   | Arithmetic parts and evidence mappings are dependency relation links.                                 | Add symbol-meaning, entity, operator, source, and belief-system dependency extraction.                          |
...
| R32 | Infer support/refutation candidates.                         | Next  | Template inference supports liveness, capital, and orbit claims.                                      | Add controlled property templates before broad extraction.                                                      |
...
| R34 | Make issue reporting easy.                                   | MVP   | Prefilled GitHub issue URL includes statement, result, evidence, and Links Notation.                  | Include live evidence status, belief profile, and browser worker errors.                                        |
