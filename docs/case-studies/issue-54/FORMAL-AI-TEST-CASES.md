...
```bash
FORMAL_AI_REPO=/tmp/formal-ai-issue72 node experiments/extract-formal-ai-test-cases.mjs
```
...
| `tests/e2e/tests/connectivity.spec.js`                     | javascript | 6     | 0       |
| `tests/e2e/tests/demo.spec.js`                             | javascript | 44    | 0       |
| `tests/e2e/tests/issue-135.spec.js`                        | javascript | 1     | 0       |
...
| `tests/e2e/tests/issue-209.spec.js`                        | javascript | 1     | 0       |
...
| `tests/e2e/tests/issue-223.spec.js`                        | javascript | 1     | 0       |
...
| `tests/e2e/tests/issue-242.spec.js`                        | javascript | 2     | 0       |
| `tests/e2e/tests/multilingual.spec.js`                     | javascript | 89    | 0       |
| `tests/integration/formal_ai_cli.rs`                       | rust       | 13    | 0       |
...
| `tests/unit/memory_maintenance.rs`                         | rust       | 2     | 0       |
| `tests/unit/mod.rs`                                        | rust       | 0     | 0       |
| `tests/unit/multilingual_variations.rs`                    | rust       | 16    | 0       |
| `tests/unit/playwright_script.rs`                          | rust       | 4     | 0       |
| `tests/unit/proof_request_config.rs`                       | rust       | 16    | 0       |
| `tests/unit/proof_request.rs`                              | rust       | 19    | 0       |
| `tests/unit/software_project.rs`                           | rust       | 4     | 0       |
| `tests/unit/specification/agent_isolation.rs`              | rust       | 11    | 0       |
| `tests/unit/specification/calculator_delegation.rs`        | rust       | 13    | 0       |
| `tests/unit/specification/capabilities.rs`                 | rust       | 5     | 0       |
| `tests/unit/specification/chat_surface.rs`                 | rust       | 68    | 2       |
| `tests/unit/specification/code_generation.rs`              | rust       | 20    | 0       |
| `tests/unit/specification/definition_fusion.rs`            | rust       | 5     | 0       |
| `tests/unit/specification/formalization.rs`                | rust       | 11    | 0       |
| `tests/unit/specification/issue_146.rs`                    | rust       | 5     | 0       |
| `tests/unit/specification/links_network.rs`                | rust       | 16    | 0       |
...
| `tests/unit/specification/reasoning_loop.rs`               | rust       | 16    | 0       |
| `tests/unit/specification/reasoning_paths.rs`              | rust       | 49    | 0       |
| `tests/unit/specification/source_cache.rs`                 | rust       | 9     | 0       |
| `tests/unit/specification/summarization_pipeline.rs`       | rust       | 11    | 0       |
| `tests/unit/specification/telegram_surface.rs`             | rust       | 14    | 1       |
| `tests/unit/specification/translation_via_links.rs`        | rust       | 23    | 0       |
| `tests/unit/specification/transparent_state.rs`            | rust       | 12    | 0       |
