const dictionaries = {
  en: {
    ...
    'translate.hint':
      'Formalize source phrases with Wikidata, then replace resolved phrases with target-language labels. Unresolved phrases become variables with questions.',
    'translate.text': 'Text',
    'translate.from': 'From',
    'translate.to': 'To',
  ...
  ru: {
    ...
    'translate.hint':
      'Сначала формализует исходные фразы через Wikidata, затем заменяет найденные фразы метками на целевом языке. Нераспознанные фразы становятся переменными с вопросами.',
