const dictionaries = {
  en: {
    ...
    'engine.label': 'Engine',
    'engine.activeJs': 'Engine: JavaScript',
    'engine.activeWasm': 'Engine: Rust (WASM)',
    'engine.loading': 'Engine: loading Rust…',
    'engine.fallback': 'Engine: JavaScript (Rust unavailable)',
  ...
  ru: {
    ...
    'engine.label': 'Движок',
    'engine.activeJs': 'Движок: JavaScript',
    'engine.activeWasm': 'Движок: Rust (WASM)',
    'engine.loading': 'Движок: загрузка Rust…',
    'engine.fallback': 'Движок: JavaScript (Rust недоступен)',
