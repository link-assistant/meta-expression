export const knownEvidence = [
  ...
  {
    key: 'earth does not orbit the sun',
    polarity: 'refute',
    weight: 1,
    sourceType: 'wikidata',
    situation: 'wikidata-structured-claim',
    ...
    claim:
      'Wikidata Q2 Earth has parent astronomical body P397 with value Q525 Sun, refuting the negated orbit claim.',
    identifiers: {
      subject: 'Q2',
      property: 'P397',
      object: 'Q525',
  ...
  },
  {
    ...
    retrievedAt: '2026-05-11',
    claim:
      'Wikidata Q405 Moon has parent astronomical body P397 with value Q2 Earth.',
    identifiers: {
      subject: 'Q405',
      property: 'P397',
      object: 'Q2',
  ...
  {
    key: 'berlin is the capital of france',
    polarity: 'refute',
    weight: 1,
    sourceType: 'wikidata',
    situation: 'wikidata-structured-claim',
    ...
    retrievedAt: '2026-05-11',
    claim:
      'Wikidata Q142 France has capital P36 with value Q90 Paris, not Q64 Berlin.',
    identifiers: {
      subject: 'Q142',
      property: 'P36',
      object: 'Q90',
  ...
  {
    key: 'berlin is the capital of germany',
    polarity: 'support',
    weight: 1,
    sourceType: 'wikidata',
    situation: 'wikidata-structured-claim',
    sourceUrl: 'https://www.wikidata.org/wiki/Q183#P36',
    retrievedAt: '2026-05-11',
    claim: 'Wikidata Q183 Germany has capital P36 with value Q64 Berlin.',
    identifiers: {
      subject: 'Q183',
      property: 'P36',
      object: 'Q64',
  ...
  },
  {
    ...
    retrievedAt: '2026-05-11',
    claim:
      'Wikidata Q317521 identifies Elon Musk as a living person with no date of death (P570) statement in the captured entity data.',
    identifiers: {
      subject: 'Q317521',
      property: 'P570',
      object: 'missing',
  ...
  {
    key: 'ada lovelace is dead',
    polarity: 'support',
    weight: 1,
    sourceType: 'wikidata',
    situation: 'wikidata-structured-claim',
    sourceUrl: 'https://www.wikidata.org/wiki/Q7259#P570',
    retrievedAt: '2026-05-11',
    claim:
      'Wikidata Q7259 Ada Lovelace has date of death P570 recorded as 1852.',
    identifiers: {
      subject: 'Q7259',
      property: 'P570',
      object: '1852',
  ...
  },
  {
    ...
    retrievedAt: '2026-05-11',
    claim:
      'Wikidata Q7259 Ada Lovelace has date of death P570 recorded as 1852, refuting the alive claim.',
    identifiers: {
      subject: 'Q7259',
      property: 'P570',
      object: '1852',
