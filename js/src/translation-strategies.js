...
const enRuGlossary = Object.freeze({
  ...
  based: 'основанный',
  by: 'с помощью',
  'case-study': 'исследование-кейс',
  'case-study research artifacts': 'артефакты исследования кейса',
  check: 'проверьте',
  compare: 'сравните',
  ...
  corpus: 'корпус',
  cst: 'CST',
  deformalization: 'деформализация',
  deterministic: 'детерминированные',
  ...
  files: 'файлы',
  formal: 'Formal',
  'formal ai compatibility hooks': 'хуки совместимости Formal AI',
  ...
  page: 'страницу',
  pinned: 'закрепленным',
  'pinned upstream test corpus': 'закрепленный тестовый корпус upstream',
  playground: 'площадка',
  possible: 'возможно',
  prompt: 'промпт',
  'prompt translation helpers': 'помощники перевода промптов',
  ...
  test: 'тестовый',
  text: 'текст',
  tracked: 'отслеживаемых',
  translation: 'перевод',
  upstream: 'upstream',
  with: 'с',
  wikidata: 'Викиданные',
  '1500-line': '1500-строчный',
  then: 'затем',
